...
np.random.seed(17342)
#MODEL_PATH = './model100/'
#DATA_PATH = './data100/'
MODEL_PATH = 'drive/project/baselineattack/model100/'
DATA_PATH = 'drive/project/baselineattack/data100/'
...
if __name__ == '__main__':
    ...
    parser.add_argument('--target_n_hidden', type=int, default=600)
    parser.add_argument('--target_epochs', type=int, default=225)
