...
#MODEL_PATH = './model/'
#DATA_PATH = './data/'
MODEL_PATH = 'drive/project/baselineattack/modelmnist/'
DATA_PATH = 'drive/project/baselineattack/datamnist/'
...
def train_target_model(dataset, epochs=100, batch_size=100, learning_rate=0.001, l2_ratio=1e-6,
                       n_hidden=784, model='nn', save=True):
...
def train_shadow_models(n_hidden=50, epochs=100, n_shadow=1, learning_rate=0.01, batch_size=100, l2_ratio=1e-7,
                        model='nn', save=True):
...
def train_attack_model(classes, dataset=None, n_hidden=50, learning_rate=0.001, batch_size=200, epochs=50,
...
def save_data():
    ...
    for i in range(args.n_shadow):
        ...
        shadow_i_indices = np.random.choice(shadow_indices, 2 * target_size, replace=True)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--target_epochs', type=int, default=300)
    ...
    parser.add_argument('--attack_n_hidden', type=int, default=200)
