...
#MODEL_PATH = './model/'
#DATA_PATH = './data/'
MODEL_PATH = 'drive/project/baselineattack/model/'
DATA_PATH = 'drive/project/baselineattack/data/'
...
def train_shadow_models(n_hidden=50, epochs=100, n_shadow=10, learning_rate=0.05, batch_size=100, l2_ratio=1e-7,
                        model='nn', save=True):
...
def attack_experiment():
    ...
    t1 = time.time()
    print('\n train target 用时%.2f seconds' % (t1 - t0))
    ...
    attack_train_x, attack_train_y, train_classes = train_shadow_models(
        ...
        save=args.save_model)
    t2 = time.time()
    print('\n train shodow 用时%.2f seconds' % (t2 - t1))
    ...
    t3 = time.time()
    print('\n train attack 用时%.2f seconds' % (t3 - t2))
    print('\n total 用时%.2f seconds' % (t3 - t0))
...
if __name__ == '__main__':
    ...
    parser.add_argument('--target_data_size', type=int, default=int(50000))  # number of data point used in target model
    ...
    parser.add_argument('--target_epochs', type=int, default=75)
    ...
    parser.add_argument('--attack_n_hidden', type=int, default=1000)
